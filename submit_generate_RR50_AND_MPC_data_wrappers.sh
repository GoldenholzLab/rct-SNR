...
do
    ...
    do
        ...
        then
            ...
            if [ $x1 == $num_training_compute_iters_per_loop ] || [ $x2 == $num_training_compute_iters_per_loop ] || [ $x3 == $num_training_compute_iters_per_loop ] || [ $x4 == $num_training_compute_iters_per_loop ] 
            then

...
do
    ...
    do
        ...
        #bash generate_TTP_data_wrapper.sh ${inputs[@]}
        sbatch generate_TTP_data_wrapper.sh ${inputs[@]}
    ...
    do
        ...
        #bash generate_TTP_data_wrapper.sh ${inputs_two[@]}
        sbatch generate_TTP_data_wrapper.sh ${inputs_two[@]}

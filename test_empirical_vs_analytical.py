...
def calculate_analytical_stat_power(patient_placebo_pop_daily_params,
    ...
    for theo_patient_index in range(num_theo_patients_per_trial_arm):
        ...
        median_percent_change_per_placebo_map_point = np.percentile(one_placebo_map_point_percent_changes, 50)
        median_percent_change_per_drug_map_point    = np.percentile(one_drug_map_point_percent_changes, 50)

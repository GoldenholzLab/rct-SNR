...
if (__name__=='__main__'):
    ...
    for iter_num in range(1, num_iter + 1):
        ...
        fisher_exact_emp_stat_power_err_sq_array[iter_num - 1] = fisher_exact_emp_stat_power_err_sq
        fisher_exact_ana_stat_power_err_sq_array[iter_num - 1] = fisher_exact_ana_stat_power_err_sq

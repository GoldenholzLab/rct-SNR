...
def generate_NV_model_hists_with_and_without_loc(one_or_two,
...
def generate_keras_formatted_NV_model_hists_with_and_without_loc(one_or_two,
    ...
    for hist_index in range(num_hists_per_trial_arm):
        ...
        [tmp_theo_placebo_arm_trial_arm_pop_wo_loc_hist,
         ...
         tmp_theo_drug_arm_trial_arm_pop_with_loc_hist] = \
             generate_NV_model_hists_with_and_without_loc(one_or_two,
                                                          current_monthly_mean,
                                                          current_monthly_std_dev,
                                                          num_theo_patients_per_trial_arm,
                                                          num_theo_patients_per_trial_arm_in_loc,
...
def generate_keras_formatted_NV_model_hists(one_or_two,
                                            num_hists_per_trial_arm,
                                            current_monthly_mean,
                                            current_monthly_std_dev,
                                            num_theo_patients_per_trial_arm,
    ...
    [keras_formatted_theo_placebo_arm_trial_arm_pop_wo_placebo_loc_hists,
     ...
     keras_formatted_theo_drug_arm_trial_arm_pop_with_placebo_loc_hists] = \
         generate_keras_formatted_NV_model_hists_with_and_without_loc(one_or_two,
                                                                      num_hists_per_trial_arm,
                                                                      current_monthly_mean,
                                                                      current_monthly_std_dev,
                                                                      num_theo_patients_per_trial_arm,
...
def generate_NV_model_SNRs_for_loc(one_or_two,
                          num_hists_per_trial_arm,
                          current_monthly_mean,
                          current_monthly_std_dev,
                          num_theo_patients_per_trial_arm,
    ...
    [keras_formatted_theo_placebo_arm_trial_arm_pop_wo_loc_hists,
     ...
     keras_formatted_theo_placebo_arm_trial_arm_pop_with_loc_hists,
     keras_formatted_theo_drug_arm_trial_arm_pop_with_loc_hists] = \
         generate_keras_formatted_NV_model_hists(one_or_two,
                                                 num_hists_per_trial_arm,
                                                 current_monthly_mean,
                                                 current_monthly_std_dev,
                                                 num_theo_patients_per_trial_arm,
...
def generate_NV_model_SNR_map(one_or_two,
                              num_hists_per_trial_arm,
                              num_theo_patients_per_trial_arm,
                              num_theo_patients_per_trial_arm_in_loc,
                              endpoint_name):
        ...
        for monthly_std_dev_index in range(15):
            ...
            if(monthly_std_dev > np.sqrt(monthly_mean)):
                ...
                [SNR_at_loc, 
                 stat_power_with_loc, 
                 stat_power_wo_loc] = \
                     generate_NV_model_SNRs_for_loc(one_or_two,
                                                    num_hists_per_trial_arm,
                                                    monthly_mean,
                                                    monthly_std_dev,
                                                    num_theo_patients_per_trial_arm,
...
if (__name__=="__main__"):
    ...
    SNR_map = \
        generate_NV_model_SNR_map(one_or_two,
                                  num_hists_per_trial_arm,
                                  num_theo_patients_per_trial_arm,
                                  num_theo_patients_per_trial_arm_in_loc,
                                  endpoint_name)
    
    with open(endpoint_name + '_NV_model_' + one_or_two + '_SNR_data.json', 'w+') as json_file:

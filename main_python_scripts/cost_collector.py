...
def text_output(dumb_num_patients_RR50,
    ...
    dumb_num_patients_str  = 'dumb:   '  + dumb_num_patients_RR50_str  + ',  ' + dumb_num_patients_MPC_str  + ',  ' + dumb_num_patients_TTP_str
    smart_num_patients_str = 'smart:  ' + smart_num_patients_RR50_str + ',  ' + smart_num_patients_MPC_str + ',  ' + smart_num_patients_TTP_str
